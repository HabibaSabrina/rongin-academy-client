...
const DashboardHeader = () => {
    ...
    <li className='border-b-2 md:mx-2 border-white'><Link to="/">Home</Link></li>
        <li className='border-b-2 md:mx-2 border-white'><Link to="/">Instructors</Link></li>
        <li className='border-b-2 md:mx-2 border-white'><Link to="/">Classes</Link></li>
        <li className='border-b-2 md:mx-2 border-white'><Link to="/">Dashboard</Link></li>
    </>
    return (
        <div>
