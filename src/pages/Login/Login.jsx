    ...
    return (
        <div className=' p-20 login-bg bg-[#f9f9e3]'>
            <div className='bg-[#f9f9e3] border-4 border-blue-800 p-10 md:mx-96 rounded-xl'>
                <h1 className='text-center text-3xl font-bold text-[#F13C20]'>Login</h1>
                <form onSubmit={handleUserLogin}>
                    <div className='text-center mt-10'>
                        <p className='font-bold text-[#F13C20]'>Email</p>
                        ...
                        <br />
                        <p className='font-bold mt-10 text-[#F13C20] '>Password</p>
                        ...
                        <br />
                        <button className='bg-[#cb890e] w-64 rounded-full p-3 text-xl text-white font-semibold hover:bg-[#aa7411] mt-10'>Login</button>
                    </div>
